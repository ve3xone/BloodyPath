...
public class MainMenuScreen
{
    ...
    {
        PlayButton.ClickableText = new ClickableText("Play", new Vector2(25, 300), Color.White, Color.Blue, delegate
        {
        ...
        ExitButton.ClickableText = new ClickableText("Exit", new Vector2(25, 325), Color.White, Color.Blue, delegate
        {
            Game.Exit();
        });
    }
